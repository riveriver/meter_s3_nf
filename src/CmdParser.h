...
/**
 * @file StringCmdParser.h
 * @brief Defines the StringCmdParser class, which provides a simple command-line
 * parser for string-based commands.
 *
 * The StringCmdParser class allows you to register commands with associated
 * callback functions, and then parse input strings to execute the corresponding
 * commands. It supports splitting the input string into tokens based on a
 * specified separator character, and dispatching the command to the registered
 * callback function.
 *
 * @author RIVER HongKong
 * @date 1/8/2024
 */
